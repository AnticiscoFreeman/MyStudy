...
class GameBS extends JFrame {
    ...
    GameBS() {
        ...
        final JButton btnShow = new JButton(BTN_SHOW_MY);
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                game.switchView();
                btnShow.setText(game.getShowMode() ? BTN_SHOW_ENEMY : BTN_SHOW_MY);
